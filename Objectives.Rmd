...
```{r}
plot(dep_delay_model_log$fitted.values, residuals(dep_delay_model_log),
     xlab = "Fitted Values",
     ylab = "Residuals",
...
**Let's take a quick look at the performance of this model.**
```{r}
summary(dep_delay_model_log)$r.squared
```
...
```{r}
plot(arr_delay_model_log$fitted.values, residuals(arr_delay_model_log),
     xlab = "Fitted Values",
     ylab = "Residuals",
     main = "Residuals vs Fitted")
abline(h = 0, col = "red")
...
**Let's take a quick look at the performance of this model.**
```{r}
summary(arr_delay_model_log)$r.squared
```
