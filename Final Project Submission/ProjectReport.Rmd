...
sample_dep_delay <- sample(flights_seasonal$dep_delay, 100)
...
The analysis provides strong evidence that the time of year is correlated with flight delays. The one-way ANOVA showed that average delays vary significantly across months, indicating a seasonal pattern. The two-way ANOVA further revealed that this pattern differs between years, suggesting that external factors (such as weather variations or changes in holiday travel demand) influence the month-to-month delay trends. The observed peaks in summer months and certain holiday periods align with periods of higher travel volume and potential weather disruptions (e.g. thunderstorms). Overall, the results support the conclusion that both holidays and seasonal weather patterns contribute to variations in flight delays throughout the year.
