...
```{r}
weather_conditions_sample <- sample(residuals(model), 30000)
# --- NORMALITY CHECKS ---
# QQ-Plot
qqnorm(weather_conditions_sample )
qqline(weather_conditions_sample , col = "red")
...
```{r}
sample_fitted <- sample(model$fitted.values, 30000)
# --- HOMOSCEDASTICITY CHECK ---
# Residuals vs Fitted plot
plot(sample_fitted, weather_conditions_sample,
