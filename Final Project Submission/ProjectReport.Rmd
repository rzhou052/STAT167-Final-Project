...
# Verify datapoints in combined dataframe
(combined_clean %>%
  group_by(dataset) %>%
...
```{r}
# One Way Anova
anova_model_weather <- aov(dep_delay ~ precip + temp + wind_gust, data = weather_conditions)
summary(anova_model_weather)
```
...
## 4. Does time of year affect flight delays?
